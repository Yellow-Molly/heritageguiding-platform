...
|---|-------|--------|--------|------|
| 01 | Measurement instrumentation + staging baseline | code-complete (staging capture pending) | 30m | — |
| 02 | Provider scaffold + shared overlay | complete | 45m | 01 |
...
| 06 | Cleanup measurement + docs sync | docs synced; instrumentation removal blocked on Phase 01 capture | 20m | 05 |
