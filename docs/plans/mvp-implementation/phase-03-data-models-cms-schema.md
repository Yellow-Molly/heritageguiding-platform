...
|----------|--------|--------|-----------|
| P1 - Critical | ✅ DONE | 28-32h | 2026-01-18 |
...
- [x] Create Tours collection with enhanced schema (logistics, inclusions, audience)
- [x] Create Guides collection with credentials
- [x] Create Categories collection (themes)
- [x] Create Neighborhoods collection (GEO)
- [x] Create Cities collection (GEO)
- [x] Create Reviews collection with ratings
- [x] Create Media collection with image sizes
- [x] Create Pages collection (FAQ, About, Terms, Privacy)
- [x] Create logistics-fields.ts (meeting point, coordinates)
- [x] Create audience-tags.ts (concierge wizard tags)
- [x] Create reusable accessibility fields
- [x] Create reusable SEO fields
- [x] Create slug field with auto-generation hook
- [x] Set up access control (isAdmin, isAuthenticated)
- [x] Register all collections in payload.config.ts
- [x] Run database migrations
- [x] Generate TypeScript types
- [x] Seed sample data for testing
- [x] Test CRUD operations via admin
- [x] Verify point field works for coordinates

## Success Criteria

- [x] All collections visible in Payload admin
- [x] CRUD operations work for all collections
- [x] Localized fields show per-locale tabs
- [x] Relationships link correctly between collections
- [x] TypeScript types generated in `payload-types.ts`
- [x] Migrations run without errors
- [x] Sample data seeded successfully
- [x] Meeting point coordinates stored correctly
- [x] Audience tags multi-select works
- [x] Static pages (FAQ, About) editable in all 3 languages
